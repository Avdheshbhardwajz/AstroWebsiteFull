          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-lg mb-6">
                Dr. Sugandha Rawat is a renowned expert in Vedic Astrology,
                Vastu Shastra, Numerology, and Face Reading with over 12 years
                of dedicated practice. Holding a PhD in Vedic sciences, she has
                a deep understanding of ancient astrological systems and their
                practical application in modern life.
              </p>
              <p className="text-lg mb-6">
                She has guided and mentored over 1,500 students through her live
                online courses, personalized consultations, and in-person
                workshops. She combines the timeless wisdom of Vedic traditions
                with engaging storytelling and real-world examples, making
                complex concepts easy to grasp.
              </p>
              <p className="text-lg">
                Beyond teaching, Dr. Sugandha offers insightful consultations
                designed to empower individuals on their journey of
                self-discovery, personal growth, and decision-making. Whether
                you are seeking guidance, eager to learn, or curious about
                unlocking your potential, Dr. Sugandha Rawat wisdom and
                experience offer a profound and enlightening journey.
              </p>
            </div>
          </div>
        </div>
  ...
  const readings = [
    {
      ...
      title: "Kundli Milan",
      description:
        "Curious if they're the one for you? Dive deep into your compatibility, uncover potential challenges, and discover where your strengths as a couple lie. Discover how your stars align, gain personalized remedies, and create a stronger, more harmonious bond with expert astrological guidance.",
      price: 3000,
    },
    {
      ...
      description:
        "Align Your Space, Elevate Your Life. Harness the ancient science of Vastu Shastra to transform your home, office, or commercial space into a hub of positivity, prosperity, and peace. We offer Residential Vastu, Commercial Vastu, Remote Consultation, and Remedy-Based Solutions.",
      price: 2000,
    },
    {
      ...
      description:
        "Guided by one of India's leading astrologers, tap into the ancient wisdom of Vedic Astrology to find clarity and direction in your life. Understand your strengths, challenges, and potential through your birth chart, and uncover practical remedies to overcome obstacles and create a more fulfilling future.",
      price: 3000,
    },
  ];
...
function CoursesSection() {
  const courses = [
    ...
    "Align Your Space with Vastu Shastra",
